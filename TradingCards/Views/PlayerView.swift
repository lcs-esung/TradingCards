...
let phoenixCard = DetailView(playerImage: "PheonixImage", frameColor: .orange, crownImage: "PheonixCrown", agentRoleImage: "DuelistImage", playerName: "Pheonix", firstUtility: "CurveBall", secondUtility: "Hothands", thirdUtility: "Blaze", ultimate: "Run It Back", biography: "Hailing from the U.K., Phoenix's star power shines through in his fighting style, igniting the battlefield with flash and flare. Whether he's got backup or not, he'll rush into a fight on his own terms.")
...
let pheonixList = ListPlayerView(iconImage: "PhoenixImage", name: "Phoenix", descriptions: "Hailing from the U.K.")
